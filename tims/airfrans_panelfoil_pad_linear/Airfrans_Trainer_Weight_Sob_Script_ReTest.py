...
from tims.airfrans_panelfoil_pad_linear.Airfrans_Delta_Config_Weight_Sob_Mirror_Y_ReTest import Default
...
loss_functions = {
    'Cp_delta': SobolevLoss(l2_weight=0.75),   # 2D spatial domain, L2 norm
    'U_x_delta': SobolevLoss(l2_weight=0.75),
    'U_y_delta': SobolevLoss(l2_weight=0.75),
...
if checkpoint_dir.exists():
    ...
    resume_from_dir = checkpoint_dir
else:
...
trainer.train(
    ...
    sample_idx=21,  # Consistent sample for diagnostic plots,
