...
from tims.airfrans_panelfoil_arcsinh_jac.Airfrans_DataProcessor_ArcSinh_Jacobian import AirfransDataProcessor_ArcSinh_Jacobian
...
input_names =  ["X", "Y", "U_x_pot", "U_y_pot","Cp_pot", "exp_sdf","arcsinh(x_xi)","arcsinh(x_eta)","arcsinh(y_xi)","arcsinh(y_eta)","log(det_J)"]
...
def get_dataset_stats(training_file):
    ...
    print(" Modifying Jacobian Coefficients with arcsinh and detJ with log")
...
class AirfransDataset(PTDataset):
    def __init__(
        ...
        self._data_processor = AirfransDataProcessor_ArcSinh_Jacobian(
