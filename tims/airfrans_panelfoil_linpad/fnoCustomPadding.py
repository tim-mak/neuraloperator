...
class FNOCustomPadding(BaseModel, name="FNO"):
    ...
    def __init__(
        ...
        domain_padding: Union[float, List[float], nn.Module] = None,
        ...
        ## Domain padding
        if isinstance(domain_padding, nn.Module):
            self.domain_padding = domain_padding
        elif domain_padding is not None and (
